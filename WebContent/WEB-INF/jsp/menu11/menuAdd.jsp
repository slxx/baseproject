...
<div id="content"> 
  ...
  <div class="container-fluid">
      ...
      <ul class="quick-actions">
        <li class="bg_lb"> <a href="javascript:add();"> <i class="icon-bc-sign"></i>保存</a> </li>
        <li class="bg_lg"> <a href="javascript:document.forms[0].reset();" > <i class="icon-cz-sign"></i>重置</a> </li>
        <li class="bg_ly"> <a href="javascript:history.back();" > <i class="icon-fh-sign"></i>返回</a> </li>
      </ul>
