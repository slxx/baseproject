  ...
  <!--
	function save(){
	  ...
	  var form=document.forms[0];
		  form.action="<%=path%>/person_updatePerson.action";
		  form.submit();
		return true;
	}
  //-->
...
<script type="text/javascript">
  ...
  <body>
    ...
    <!--main-container-part-->
<s:form action="person_updatePerson.action" method="post">
<s:hidden name="person.personId"/>
<s:hidden name="person.isValid" value="true"/>
<s:hidden name="person.user.userId"/>
<s:hidden name="person.rent.rentId"/>
<s:hidden name="person.operDateTime"/>
<s:hidden name="person.operUserId"/>
    ...
    <div class="widget-box">
      ...
      <div class="widget-content">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td class="td_r"><span style="color: red">*</span>地 址:</td>
