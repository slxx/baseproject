...
<SCRIPT LANGUAGE="JavaScript">
  <!--
	function save(){
	  ...
	  var form=document.forms[0];
		  form.action="<%=path%>/role_updateRole.action";
		  form.submit();
		return true;
	}
  //-->
  ...
  <body>
<s:form action="role_updateRole.action" method="post">
...
<div id="content"> 
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td class="td_r">角色属性:</td><td class="td_l"><s:radio name="role.rolePropertier"
									list='#{ 0:"系统角色",1:"普通角色"}' ></s:radio>
							</td>
						</tr>
					</table>
 </div>
