...
<link rel="stylesheet" type="text/css" href="<%=path %>/css/tree_themes/SimpleTree.css"/>
<script type="text/javascript" src="<%=path %>/js/jquery-1.4.2min.js"></script>
    ...
    <div class="widget-box">
      ...
      <div class="widget-content">
          ...
          <div class="tree_l">
            ...
            <div class="st_tree" >
		<ul>
			 <c:forEach items="${menuTreeList}" var="entry">
			<li class="dd-item dd3-item" ><a href="#" onclick="clickAddMenu('${entry.menuId }')"  >
			     ${entry.menuName }
			     </a></li>
		     	<c:forEach items="${entry.childMenu}" var="childMenu">
		     	<c:if test="${childMenu.isValid==true}">
			    <ul show="true">
					<li class="dd-item dd3-item"><a href="#"   >${childMenu.menuName }</a></li>
				</ul>
				</c:if>
				</c:forEach>
			</c:forEach>
